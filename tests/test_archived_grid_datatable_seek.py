...
def test_citation_grid_map_routes_harvest_away_from_tier_frontier():
    ...
    assert PakistanLawSitePipeline._is_citation_grid_map(grid_map)
    form_map = {
        "fields": {"reporter": {}, "year": {}, "page": {}},
        "result_layout": {"row_selector": "table#results tr"},
        "limits": {"surface": "query_form"},
    }
    assert not PakistanLawSitePipeline._is_citation_grid_map(form_map)
