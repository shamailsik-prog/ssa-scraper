...
scraper/security.py          allow-list, SSRF, robots,     scraper/tasks/pakistancode.py     PakistanCode statutes
                             block detection, scrubbing    scraper/tasks/legislatures.py     NA, Senate, 4 assemblies, Gazette (PAKP + PAB + PAP + PAS acts-table/deep-link direct-doc routing with row metadata + %PDF gate)
