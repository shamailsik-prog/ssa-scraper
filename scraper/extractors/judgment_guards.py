...
def login_subscription_chrome_dominates(
    *,
    ...
    """Return a marker name when login/subscription chrome dominates; None for crumbs.

    Incidental nav/footer/cookie leftovers on a long real judgment must not
    quarantine. Markers must be the main content.
    """
